...
const Event_box_small_home = ({InPageEventInfor = EventInfoFromDBDefault}:{InPageEventInfor?:EventInfoFromDB} ) => {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
  return (<div>
      <div className="absolute w-[380px] h-[250px] bg-gray-100 rounded-[10px] m-[10px] items-center box-border flex border-[1px] border-gray-300 group cursor-pointer" onClick={()=>{loadPage(`/Eventdetail_page/${InPageEventInfor.id}`)}}>
  
          <div className=" w-full h-[230px] flex-shrink-0 overflow-hidden">
          ...
          <div className="absolute left-[5px] bottom-[21px] h-[40px] w-[350px]">
            <div className=" text-[18px] font-bold text-white ml-[5px]">{eventInfor.eventName}</div>
            <div className="flex">
              <div className=" text-[16px] text-white mt-[1px] ml-[1px] inline-flex">
                <Calendar className="mt-[3px] w-[25px] h-[16px]"></Calendar>
                {eventInfor.eventDate}
              </div>
              <div className=" text-[16px] text-white mt-[1px] ml-[5px] inline-flex">
...
export default Event_box_small_home;