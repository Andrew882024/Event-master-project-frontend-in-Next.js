...
import Event_box_cluster_home from "@/src/component/big_component/Event_box_cluster_home";
  ...
  return(<div className="absolute top-0 left-0 bg-gray-50 min-h-screen w-screen overflow-x-hidden">
    ...
    <div className="absolute top-[70px] left-0 w-screen bg-gray-50 bg-opacity-90">
      ...
      <div className=" mt-[160px] flex flex-col items-center justify-center">
        ...
        <div className="h-[3px] w-[200px] bg-gray-300 mt-[30px] mb-[180px] rounded-full"></div>
      </div>
